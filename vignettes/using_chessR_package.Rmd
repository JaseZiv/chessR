...
chessdotcom_game_data <- get_raw_chessdotcom("JaseZiv")
glimpse(chessdotcom_game_data)
```
...
chessdotcom_game_data$nMoves <- return_num_moves(moves_string = chessdotcom_game_data$Moves)

# inspect output
head(chessdotcom_game_data[, c("Moves", "nMoves")])
```
...
chessdotcom_game_data$Ending <- get_game_ending(termination_string = chessdotcom_game_data$Termination, 
                                          white = chessdotcom_game_data$White, 
                                          black = chessdotcom_game_data$Black)

# inspect output
head(chessdotcom_game_data[, c("Termination", "White", "Black", "Ending")])
```
...
chessdotcom_game_data$Winner <- get_winner(result_column = chessdotcom_game_data$Result, 
                                     white = chessdotcom_game_data$White, 
                                     black = chessdotcom_game_data$Black)

# inspect output
head(chessdotcom_game_data[, c("White", "Black", "Result", "Winner")])
```
