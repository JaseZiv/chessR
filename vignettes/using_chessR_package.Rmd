...
As of version 1.2.2, `get_raw_chessdotcom()` now accepts an additional argument called `year_month`, a six digit integer of YYYMM, which allows users to filter on which month(s) data is required for.
...
```{r game_ending, eval=FALSE}
# function to extract the ending of chess.com data
chessdotcom_game_data_all_months$Ending <- get_game_ending(termination_string = chessdotcom_game_data_all_months$Termination, 
