...
df <- analyse_player_games("JaseZiv")



analyse_multiple_players <- function(usernames) {
  df <- map_df(usernames, analyse_player_games)
...
names_users <- c("JaseZiv", "Smudgy1", "stevecondy")



test <- analyse_multiple_players(names_users)
